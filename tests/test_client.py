...
from test_project7007 import Petstore, AsyncPetstore, APIResponseValidationError
from test_project7007._types import Omit
from test_project7007._models import BaseModel, FinalRequestOptions
from test_project7007._constants import RAW_RESPONSE_HEADER
from test_project7007._exceptions import PetstoreError, APIStatusError, APITimeoutError, APIResponseValidationError
from test_project7007._base_client import (
    DEFAULT_TIMEOUT,
...
class TestPetstore:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "test_project7007/_legacy_response.py",
                        "test_project7007/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "test_project7007/_compat.py",
    ...
    @mock.patch("test_project7007._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncPetstore:
    ...
    def test_get_platform(self) -> None:
        ...
        from test_project7007._utils import asyncify
        from test_project7007._base_client import get_platform 
